...
#define HX_H1(s,i,x)   ((uint32_t)0x61C88647*x^(uint32_t)s[(i)<sizeof(s)?(i):(sizeof(s)-1)])
...
#define hxHashStringLiteral(s) (uint32_t)HX_H64(s,0,HX_H64(s,64,HX_H64(s,128,(uint32_t)0)))
#else
