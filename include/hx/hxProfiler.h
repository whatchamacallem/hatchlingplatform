...
// labelStaticString is kept.  c_hxProfilerDefaultSamplingCutoff is provided below as
// a recommended MinCycles cutoff.

// hxProfileScope(const char* labelStaticString)
#define hxProfileScope(labelStaticString) \
	hxProfilerScopeInternal<> HX_CONCATENATE(hxProfileScope_,__LINE__)(labelStaticString)

// hxProfileScopeMin(const char* labelStaticString, uint32_t minCycles)
