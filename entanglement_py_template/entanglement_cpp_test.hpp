...
//float fn1(int a) { g_a = a; return fn1(); }
...
//float fn1(bool a, unsigned short b, float c) { g_a = a; g_b = b; g_c = c; return fn1(); }
...
//float fn1(double f, float g) { g_f = f; g_g = g; return fn1(); }
